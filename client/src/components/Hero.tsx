...
export default function Hero() {
  ...
  const trailImages = [weddingImage, eventImage, portraitImage, productImage];
  ...
  return (
    <div className="min-h-screen" ref={trailContainerRef}>
      <RadiusOnScroll
        imageUrl={heroImage}
        startRadius={0}
        endRadius={48}
        startPadding={0}
        endPadding={48}
        startTrigger="exit-top"
        endTrigger="exit-bottom"
      ...
      >
        ...
        <div className="relative z-20 w-full max-w-7xl mx-auto px-6 lg:px-8 py-32 min-h-screen flex items-center">
