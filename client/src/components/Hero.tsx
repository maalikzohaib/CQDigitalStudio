...
import { useRadiusOnScroll } from "@/hooks/useRadiusOnScroll";
...
export default function Hero() {
  ...
  const { containerRef, containerStyle } = useRadiusOnScroll({
    startRadius: 0,
    endRadius: 48,
    startPadding: 0,
    endPadding: 24,
    startTrigger: "exit-top",
    endTrigger: "exit-center",
  ...
  return (
    <div ref={containerRef} style={containerStyle} className="transition-all duration-100" data-testid="hero-radius-container">
