  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      <Button
        ...
        className={cn(
          "whatsapp-button h-14 w-14 rounded-full shadow-lg transition-all duration-300",
      ...
      {isOpen && (
        <div
          ref={chatRef}
          className="absolute bottom-20 right-0 w-80 bg-background border border-border rounded-lg shadow-2xl overflow-hidden animate-in slide-in-from-bottom-4 duration-300"
        >
          {/* Header */}
