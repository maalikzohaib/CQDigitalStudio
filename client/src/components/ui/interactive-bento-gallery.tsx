    ...
    return (
        <>
            ...
            <motion.div
                ...
                className="fixed inset-0 w-full h-full backdrop-blur-lg overflow-hidden z-10"

            >
                {/* Main Content */}
                <div className="h-full w-full flex items-center justify-center p-4 sm:p-6 md:p-8 bg-gray-50/50">
                    <AnimatePresence mode="wait">
                        <motion.div
                            key={selectedItem.id}
                            className="relative w-full max-w-[95%] sm:max-w-[85%] md:max-w-5xl 
                                     aspect-[16/9] rounded-xl overflow-hidden shadow-2xl"
                            ...
                            onClick={onClose}
                        >
                            <MediaItem item={selectedItem} className="w-full h-full object-cover bg-gray-900/20" onClick={onClose} />
            ...
            <motion.div
                ...
                dragElastic={0.1}
                initial={{ x: "-50%", y: 0 }}
                animate={{ x: `calc(-50% + ${dockPosition.x}px)`, y: dockPosition.y }}
                onDragEnd={(_, info) => {
                ...
                className="fixed z-50 left-1/2 bottom-32 touch-none"
            >
                <motion.div
    ...
    return (
        <div className="container mx-auto px-4 py-8 max-w-7xl">
            <div className="mb-12 text-center">
                ...
                <motion.p
                    className="mt-3 text-base sm:text-lg text-gray-600 dark:text-gray-400"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
